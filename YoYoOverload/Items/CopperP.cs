	...
	public class CopperP : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.frameCounter >= 70)
			{
				...
				int num2 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, vector.X, vector.Y, 158, base.projectile.damage, (float)base.projectile.owner, 0, 0f, 0f);

	...
	public class PrimeLaser : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.frameCounter % 120 == 0)
			{
				...
				int num = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, vector.X, vector.Y, 100, base.projectile.damage, (float)base.projectile.owner, 0, 0f, 0f);

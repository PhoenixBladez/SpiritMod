...
{
	public class ReapP : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (base.projectile.frameCounter >= 130)
			{
				...
				int num2 = Projectile.NewProjectile(base.projectile.Center.X, base.projectile.Center.Y, vector.X, vector.Y, base.mod.ProjectileType("ReapT"), base.projectile.damage, (float)base.projectile.owner, 0, 0f, 0f);

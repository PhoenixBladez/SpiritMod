...
{
    public class CogW : ModProjectile
    {
        ...
        public override void Kill(int timeLeft) {
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<ChaosB>(), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);

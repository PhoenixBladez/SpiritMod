...
namespace SpiritMod.YoYoOverload.Projectiles
{
	public class CogW : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("ChaosB"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);

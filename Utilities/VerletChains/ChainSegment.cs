...
namespace SpiritMod.VerletChains
{
	public class ChainSegment
	{
		...
		public void Draw(SpriteBatch sB, Texture2D texture, Color color = default) => sB.Draw(texture, Vertex2.Position - Main.screenPosition, null, Lighting.GetColor((int)Vertex2.Position.X / 16, (int)((double)Vertex2.Position.Y / 16.0)), Rotation(), new Vector2(0f, texture.Height / 2f), Vector2.One, SpriteEffects.None, 0);
	}
}

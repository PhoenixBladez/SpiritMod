...
namespace SpiritMod.Mechanics.QuestSystem.Quests
{
    public class StylistQuestCorrupt : Quest
    {
		...
		private void QuestGlobalNPC_OnEditSpawnPool(IDictionary<int, float> pool, NPCSpawnInfo spawnInfo) => ModifySpawnRateUnique(pool, ModContent.NPCType<NPCs.Cystal.Cystal>(), 0.185f);
	}
}
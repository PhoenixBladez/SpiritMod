    ...
    public class AnglerStatueQuest : Quest
    {
		...
		private AnglerStatueQuest()
        {
			...
			branch1.AddTask(new RetrievalTask(ItemID.RedSnapper, 3424, "Appease him by catching"))
			       .AddTask(new GiveNPCTask(NPCID.Angler, ItemID.RedSnapper, 3424, "How is this supposed to make me feel better? Are you trying to show me up, too?! You should just stick to running my errands and catching my fish. Thanks for nothing!", "Give the Salmon to the Angler", true, true));

...
namespace SpiritMod.Mechanics.QuestSystem.Quests
{
    public class SlayerQuestWinterborn : Quest
    {
        ...
        {
            _questTasks.Add(new SlayTask(new int[] { ModContent.NPCType<NPCs.Winterborn.WinterbornMelee>(), ModContent.NPCType<NPCs.WinterbornHerald.WinterbornMagic>()}, 8, "Winterborn"));
        }
    }
}
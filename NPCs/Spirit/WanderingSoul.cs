...
namespace SpiritMod.NPCs.Spirit
{
	public class WanderingSoul : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			return SpawnTiles.Contains(Main.tile[spawnInfo.spawnTileX, spawnInfo.spawnTileY].type) && !spawnInfo.playerSafe && !spawnInfo.invasion && NPC.downedMechBossAny ? 1.59f : 0f;
		}

	...
	public class Marble_Boulder : ModProjectile
	{
		...
		public override void AI()
		{
			...
			for (int index = 0; index < 6; ++index)
			{
				...
				{
					Dust dust = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 236, projectile.velocity.X, projectile.velocity.Y, 100, new Color(), 1f)];

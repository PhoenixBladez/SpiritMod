...
namespace SpiritMod.NPCs.Boulder_Termagant
{
	public class Granite_Boulder : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Granite Boulder");
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Main.spriteBatch.Draw(mod.GetTexture("NPCs/Boulder_Termagant/Granite_Boulder_Glow"), position, new Microsoft.Xna.Framework.Rectangle?(new Microsoft.Xna.Framework.Rectangle(0, y2, texture.Width, height)), lightColor, projectile.rotation, new Vector2((float) texture.Width / 2f, (float) height / 2f), projectile.scale, effects1, 0.0f);
			return true;
		}
		public override void AI()
		{
			...
			for (int index = 0; index < 6; ++index)
			{
				...
				{
					Dust dust = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 229, projectile.velocity.X, projectile.velocity.Y, 100, new Color(), 1f)];

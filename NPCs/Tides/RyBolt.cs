...
namespace SpiritMod.NPCs.Tides
{
	public class RyBolt : ModProjectile, ITrailProjectile
	{
		...
		{
			tM.CreateTrail(Projectile, new StandardColorTrail(new Color(181, 120, 255)), new RoundCap(), new DefaultTrailPosition(), 28f, 430f, new ImageShader(Mod.Assets.Request<Texture2D>("Textures/Trails/Trail_3", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value, 0.08f, 1f, 1f));

...
{
	public class Letter_4 : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor)
		{
			if (Projectile.timeLeft < 260)
			{
				...
				for (int index = 10; index >= 0; --index)
				{
					...
					Microsoft.Xna.Framework.Color color2 = Microsoft.Xna.Framework.Color.Lerp(Color.Crimson, Color.LightPink, amount);
					color2 = Microsoft.Xna.Framework.Color.Lerp(color2, Color.DarkOrchid, (float) index / 4f);

...
namespace SpiritMod.NPCs.Undead_Warlock
{
	public class Undead_Warlock_NPC : GlobalNPC
	{
		...
		public override void PostDraw(NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			...
			{
				int num7 = 16;
				float num8 = (float) (Math.Cos((double) Main.GlobalTimeWrappedHourly % 2.40000009536743 / 2.40000009536743 * 6.28318548202515) / 2.0 + 0.5);
				float num10 = 0.0f;
				float addY = 0f;
				float addHeight = 0f;
				...
				for (int index2 = 0; index2 < num7; ++index2)
				{
					...
					Main.spriteBatch.Draw(TextureAssets.Npc[npc.type].Value, position2, new Microsoft.Xna.Framework.Rectangle?(npc.frame), color3, npc.rotation, vector2_3, npc.scale, spriteEffects, 0.0f);
				}
				Main.spriteBatch.Draw(TextureAssets.Npc[npc.type].Value, position1, new Microsoft.Xna.Framework.Rectangle?(npc.frame), color2, npc.rotation, vector2_3, npc.scale, spriteEffects, 0.0f);
			}
			if (isMagicalShrapneled)
			{
				int num7 = 16;
				...
				for (int index2 = 0; index2 < num7; ++index2)
				{
					...
					Main.spriteBatch.Draw(TextureAssets.Npc[npc.type].Value, position2, new Microsoft.Xna.Framework.Rectangle?(npc.frame), color2, npc.rotation, vector2_3, npc.scale, spriteEffects, 0.0f);
				}
				Main.spriteBatch.Draw(TextureAssets.Npc[npc.type].Value, position1, new Microsoft.Xna.Framework.Rectangle?(npc.frame), color2, npc.rotation, vector2_3, npc.scale, spriteEffects, 0.0f);
			}
		}

...
namespace SpiritMod.NPCs.Critters
{
	public class FrostMinnow : ModNPC
	{
		...
		{
			if (NPC.life <= 0) {
				Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/FrostMinnow1").Type, 1f);
				Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/FrostMinnow2").Type, 1f);
			}
		}

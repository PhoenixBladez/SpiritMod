...
namespace SpiritMod.NPCs.Critters
{
	public class AtlanticCod : ModNPC
	{
		...
		{
			if (NPC.life <= 0) {
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("SpiritMod/Gores/AtlanticCod1").Type, 1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("SpiritMod/Gores/AtlanticCod2").Type, 1f);
			}
		}

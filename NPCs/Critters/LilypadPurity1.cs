...
{
	public class LilypadPurity1 : ModNPC
	{
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            {
                return !player.GetSpiritPlayer().ZoneReach && player.ZoneOverworldHeight && spawnInfo.water && Main.dayTime && !player.ZoneJungle && !player.ZoneBeach && !player.ZoneCrimson && !player.ZoneCorrupt ? 2f : 0f;
            }
            return 0f;
        }
    }

...
namespace SpiritMod.NPCs.Critters
{
	public class Ebonkoi : ModNPC
	{
		...
		{
			if (NPC.life <= 0) {
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Ebonkoi1").Type, 1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Ebonkoi2").Type, 1f);
			}
		}

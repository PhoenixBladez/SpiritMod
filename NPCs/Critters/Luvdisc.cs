...
namespace SpiritMod.NPCs.Critters
{
	public class Luvdisc : ModNPC
	{
		...
		{
			if (NPC.life <= 0) {
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Luvdisc").Type, 1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Luvdisc1").Type, 1f);
			}
		}

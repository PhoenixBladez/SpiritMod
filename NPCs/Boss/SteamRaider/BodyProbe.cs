...
namespace SpiritMod.NPCs.Boss.SteamRaider
{
    public class BodyProbe : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor) {
            ...
            Microsoft.Xna.Framework.Color color3 = new Microsoft.Xna.Framework.Color(112, 238, 255) * 1.6f;
            ...
            shoottimer++;
            {
                if(shoottimer >= 140) {
                    ...
                    for(int i = 0; i < amountOfProjectiles; ++i) {
                        ...
                        int num945 = expertMode ? 14 : 24;
                        int p = Projectile.NewProjectile(npc.Center.X, npc.Center.Y, direction.X + A, direction.Y + B, 440, num945, 1, Main.myPlayer, 0, 0);

...
namespace SpiritMod.NPCs.Boss.Occultist.Projectiles
{
	public class OccultistHand : ModProjectile, ITrailProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int j = 0; j < 6; j++)
				Gore.NewGore(Projectile.GetSource_Death(), Projectile.Center, Main.rand.NextVector2Unit() * Main.rand.NextFloat(), Mod.Find<ModGore>("SpiritMod/Gores/Skelet/grave" + Main.rand.Next(1, 5)).Type, 0.5f);
		}

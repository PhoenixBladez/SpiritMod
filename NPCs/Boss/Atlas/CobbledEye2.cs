...
{
	public class CobbledEye2 : ModNPC
	{
		int timer = 0;
		bool start = true;
		...
		public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) => GlowmaskUtils.DrawNPCGlowMask(spriteBatch, NPC, Mod.Assets.Request<Texture2D>("NPCs/Boss/Atlas/CobbledEye_Glow").Value, screenPos);

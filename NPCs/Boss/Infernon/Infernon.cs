...
namespace SpiritMod.NPCs.Boss.Infernon
{
	...
	public class Infernon : ModNPC, IBCRegistrable
	{
		...
		public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) => GlowmaskUtils.DrawNPCGlowMask(spriteBatch, NPC, Mod.GetTexture("NPCs/Boss/Infernon/Infernon_Glow"));

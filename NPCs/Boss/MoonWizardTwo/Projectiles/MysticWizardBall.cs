    ...
    public class MysticWizardBall : ModProjectile, IDrawAdditive
    {
		...
		public override void AI()
		{
			...
			if (projectile.timeLeft % 10 == 0)
            {
                ...
                int p = Projectile.NewProjectile(projectile.Center.X + Main.rand.Next(-50, 50), projectile.Center.Y + Main.rand.Next(-50, 50), vector2_2.X, vector2_2.Y, ModContent.ProjectileType<MysticWizardBallEnergyEffect>(), 0, 0.0f, Main.myPlayer, 0.0f, (float)projectile.whoAmI);

...
namespace SpiritMod.NPCs.ElectricEel
{
	public class ElectricEel : ModNPC
	{
		...
		public override void PostDraw(SpriteBatch spriteBatch, Color drawColor) => GlowmaskUtils.DrawNPCGlowMask(spriteBatch, npc, mod.GetTexture("NPCs/ElectricEel/ElectricEel_Glow"));

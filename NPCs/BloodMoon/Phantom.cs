...
namespace SpiritMod.NPCs.BloodMoon
{
	...
	public class Phantom : ModNPC
	{
		...
		{
			return spawnInfo.player.ZoneOverworldHeight && (Main.hardMode) && !Main.dayTime && !spawnInfo.player.ZoneSnow && !spawnInfo.player.ZoneCorrupt && !spawnInfo.player.ZoneCrimson && !spawnInfo.player.ZoneHoly ? 0.015f : 0f;
		}

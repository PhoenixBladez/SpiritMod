	...
	public class BloodGazerEye : ModNPC
	{
		...
		public override void OnKill()
		{
			if (!Main.dedServ)
			{
				...
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity / 2, Mod.Find<ModGore>("Gazer/GazerEye").Type, 1f);
				foreach (var segment in _chain.Segments)
					Gore.NewGore(NPC.GetSource_Death(), segment.Vertex2.Position, NPC.velocity / 2, Mod.Find<ModGore>("Gazer/GazerChain").Type, 1f);
			}
		}
	}
}
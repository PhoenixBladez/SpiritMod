...
namespace SpiritMod.NPCs.ChainedSinner
{
    internal class ChainedSinner : ModNPC
    {
		...
		public void InitializeChain(Vector2 position) => chain = new Chain(mod.GetTexture("NPCs/ChainedSinner/ChainedSinner_Chain"), mod.GetTexture("NPCs/ChainedSinner/ChainedSinner_Chain"), 16, 16, position, true, false);

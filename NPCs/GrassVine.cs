...
namespace SpiritMod.NPCs
{
	public class GrassVine : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			{
				return spawnInfo.player.GetSpiritPlayer().ZoneReach && !Main.dayTime ? 0.8f : 0f;
			}
			return 0f;
		}
        ...
        {
            GlowmaskUtils.DrawNPCGlowMask(spriteBatch, npc, mod.GetTexture("NPCs/GrassVine_Glow"));
        }	

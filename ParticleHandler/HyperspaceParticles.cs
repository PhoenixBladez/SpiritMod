...
namespace SpiritMod.ParticleHandler
{
	...
	{
		public HyperspaceParticles() : base(new ParticleSystem("SpiritMod/ParticleHandler/HyperspaceParticle", OnUpdate), 
			delegate { return Main.LocalPlayer.GetModPlayer<MyPlayer>().ZoneSynthwave; }, 

...
namespace SpiritMod.Particles
{
	public class SnowflakeParticle : Particle
	{
		...
		public override void CustomDraw(SpriteBatch spriteBatch)
		{
			...
			Texture2D bloom = Terraria.ModLoader.ModContent.Request<Texture2D>("SpiritMod/Effects/Masks/CircleGradient", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;

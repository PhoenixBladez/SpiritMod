...
using SpiritMod.Items.Sets.SepulchreLoot.GraveyardTome;
using System;
using Terraria;
...
namespace SpiritMod.Particles
{
	public class GraveyardPortalParticle : Particle
	{
		...
		public override void Update()
		{
			...
			Color = new Color(21, 175, 8) * opacity * (proj.scale / GraveyardPortal.MaxScale);
			Lighting.AddLight(Position, Color.R / 255f, Color.G / 255f, Color.B / 255f);

			Position = proj.Center + offset;
			Velocity = Vector2.Lerp(Velocity, Vector2.Normalize(proj.Center - Position), 0.04f);
			offset += Velocity;

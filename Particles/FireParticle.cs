...
namespace SpiritMod.Particles
{
	public class FireParticle : Particle
	{
		...
		public override float SpawnChance() => Main.LocalPlayer.ZoneMeteor || Main.LocalPlayer.ZoneUnderworldHeight ? 0.62f : 0;
		...
		public override void OnSpawnAttempt()
		{
			...
			Vector2 startingPosition = new Vector2(Main.rand.NextFloat(screenCenter.X - Main.screenWidth * 2, screenCenter.X + Main.screenWidth * 2), Main.screenPosition.Y + Main.screenHeight * 2);

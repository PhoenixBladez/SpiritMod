	...
	public class CoconutP : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			if (cracky) {
				...
				Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, GoreVel, Mod.Find<ModGore>("Coconut/CoconutGore1").Type, 1f);
				GoreVel.X = -2f;
				Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, GoreVel, Mod.Find<ModGore>("Coconut/CoconutGore2").Type, 1f);
			}
			else {
				Vector2 GoreVel = Projectile.velocity;
				...
				GoreVel.Y *= -0.2f;
				int g = Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, GoreVel, Mod.Find<ModGore>("Coconut/CoconutGore").Type, 1f);

...
namespace SpiritMod.Projectiles.Thrown
{
	public class DragonGrenade : ModProjectile
	{
		...
		{
			int dust = Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height - 16, 244, projectile.velocity.X * 0.5f, projectile.velocity.Y * 0.5f);
			int dust2 = Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height - 16, 244, projectile.velocity.X * 0.5f, projectile.velocity.Y * 0.5f);
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("BetsyFire"), projectile.damage / 2 * 3, projectile.knockBack, projectile.owner, 0f, 0f);

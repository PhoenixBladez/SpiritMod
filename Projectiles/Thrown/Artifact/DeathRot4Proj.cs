    ...
    public class DeathRot4Proj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit) {
            if(Main.rand.Next(4) == 0)
                target.AddBuff(ModContent.BuffType<Necrosis>(), 600);
        ...
        public override void Kill(int timeLeft) {
            ...
            if(Main.rand.Next(4) == 0) {
                ...
                for(int i = 0; i < n; i++) {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<PestilentFlame>(), projectile.damage / 3 * 4, 2, projectile.owner);
                }
            }

	...
	public class TungstenShurikenProjectile : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			if (Main.rand.Next(0, 4) == 0)
				Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("TungstenShuriken"), 1, false, 0, false, false);

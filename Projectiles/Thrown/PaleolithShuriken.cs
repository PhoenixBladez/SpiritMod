	...
	public class PaleolithShuriken : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			if (Main.rand.Next(0, 4) == 0)
				Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("PaleolithShuriken"), 1, false, 0, false, false);

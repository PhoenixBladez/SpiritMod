	...
	public class HydrothermalVentPlume : ModProjectile
	{
		...
		public override bool PreAI()
		{
			...
			if (projectile.timeLeft % 10 == 0)
            {
				...
				Item.NewItem(new Vector2(projectile.Center.X + Main.rand.Next(-10, 10), projectile.Center.Y + Main.rand.Next(-10, 10)), 0, 0, ModContent.ItemType<Items.Sets.FloatingItems.Kelp>(), 1, false, 0, false);
			}
		...
		private void SpawnDust(int side)
		{
			...
			Dust dust81 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, 31, 0f, speedY, 0, default, 1f)];
			dust81.alpha = 200;

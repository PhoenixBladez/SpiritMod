...
namespace SpiritMod.Projectiles
{
	public class BlueFist : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<Wrath>(), projectile.damage / 5 * 3, projectile.knockBack, projectile.owner, 0f, 0f);
			for (int i = 0; i < 40; i++) {

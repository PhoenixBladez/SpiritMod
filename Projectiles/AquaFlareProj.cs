...
{
	public class AquaFlareProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				int num3 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, (float)num, (float)num2, mod.ProjectileType("AquaBolt"), 52, projectile.knockBack, projectile.owner, 0f, 0f);
			...
			{
				int num5 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, (float)num, (float)num2, mod.ProjectileType(""), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
				Main.projectile[num5].localAI[0] = (float)projectile.whoAmI;
			}
			if ((int)projectile.localAI[1] == 30)
			{
				int num6 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, (float)num, (float)num2, mod.ProjectileType("FireBolt"), 47, projectile.knockBack, projectile.owner, 0f, 0f);

...
namespace SpiritMod.Projectiles
{
	public class BrainProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				int num3 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, (float)num, (float)num2, mod.ProjectileType("BoCShurikenProj"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
			...
			else if ((int)projectile.localAI[1] == 30)
			{
			...
			else if ((int)projectile.localAI[1] == 40)
			{

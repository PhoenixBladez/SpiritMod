	...
	public class MorningtideProjectile : ModProjectile, IDrawAdditive
	{
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int i = 0; i < amount; ++i)
            {
                ...
                Projectile.NewProjectile(pos.X, pos.Y, spX * projectile.direction, spY, ModContent.ProjectileType<MorningtideProjectile2>(), projectile.damage/2, 2, Main.player[projectile.owner].whoAmI);
            }
        }
		...
		public override void Kill (int timLeft)
        {
            ...
            for (int k = 0; k < 18; k++)
            {
                ...
                Dust d = Dust.NewDustPerfect(projectile.Center, 222, Vector2.One.RotatedByRandom(6.28f) * Main.rand.NextFloat(5), 0, default, 0.75f);
                d.noGravity = true;

                Dust d1 = Dust.NewDustPerfect(projectile.Center, 222, Vector2.One.RotatedByRandom(6.28f) * Main.rand.NextFloat(5), 0, default, 0.75f);

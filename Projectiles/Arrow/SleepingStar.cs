...
namespace SpiritMod.Projectiles.Arrow
{
	public class SleepingStar : ModProjectile, ITrailProjectile
	{
		...
		public void DoTrailCreation(TrailManager tManager) => tManager.CreateTrail(projectile, new StandardColorTrail(new Color(120, 217, 255)), new RoundCap(), new SleepingStarTrailPosition(), 8f, 250f);

	...
	public class GobSorcererOrb : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
		{
            ...
            for (int I = 0; I < 3; I++)
            {
                ...
                int p = Projectile.NewProjectile(Projectile.GetSource_Death(), pos.X, pos.Y, velocity.X, velocity.Y, ModContent.ProjectileType<Projectiles.Magic.ShadowflameOrbBolt>(), Projectile.damage, Projectile.knockBack, 0, 0.0f, 0.0f);

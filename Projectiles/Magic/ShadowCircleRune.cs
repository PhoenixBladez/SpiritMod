			...
			if (projectile.frameCounter >= 30)
			{
				...
				if (num2 != -1)
				{
					...
					if (flag)
					{
						...
						value *= num5;
						int p = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value.X, value.Y, ModContent.ProjectileType<CrystalShadow>(), projectile.damage, projectile.knockBack / 2f, projectile.owner, 0f, 0f);

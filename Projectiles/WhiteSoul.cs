...
namespace SpiritMod.Projectiles
{
	public class WhiteSoul : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Soul Wisp");
		}
		...
		public override void AI()
		{
			...
			for (int index1 = 0; index1 < 5; ++index1)
			{
				...
				int index2 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 66, 0.0f, 0.0f, 100, new Color(), 1.3f);

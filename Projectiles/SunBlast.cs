...
namespace SpiritMod.Projectiles
{
	class SunBlast : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("HostileWrath"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);

	...
	public class FireballProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Projectile.frameCounter >= 180) {
				...
				int proj = Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center.X, Projectile.Center.Y, velocity.X, velocity.Y, ProjectileID.BallofFire, Projectile.damage, Projectile.owner, 0, 0f);

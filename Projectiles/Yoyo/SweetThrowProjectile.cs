	...
	public class SweetThrowProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (projectile.frameCounter >= 100) {
				...
				int proj = Terraria.Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, velocity.X, velocity.Y, ProjectileID.Bee, projectile.damage/3, projectile.owner, 0, 0f);

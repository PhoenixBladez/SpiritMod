...
namespace SpiritMod.Projectiles.Clubs
{
	class FloranBludgeonProj : ClubProj
	{
		...
		public override void Smash(Vector2 position)
		{
            ...
            for (int k = 0; k <= 14; k++)
            {
                Dust.NewDustPerfect(projectile.oldPosition + new Vector2(projectile.width / 2, projectile.height / 2), DustType<Dusts.FloranClubDust>(), new Vector2(0, 1).RotatedByRandom(1) * Main.rand.NextFloat(-1, 1) * projectile.ai[0] / 10f);
            }

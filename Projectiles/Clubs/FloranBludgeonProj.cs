...
namespace SpiritMod.Projectiles.Clubs
{
	class FloranBludgeonProj : ClubProj
	{
		...
		public override void Smash(Vector2 position)
		{
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromAI("ClubSmash"), Projectile.Center.X, Projectile.Center.Y - 32, 0, 0, ProjectileType<BoneShockwave>(), Projectile.damage / 3, Projectile.knockBack / 2, Projectile.owner, 8, player.direction);
		}

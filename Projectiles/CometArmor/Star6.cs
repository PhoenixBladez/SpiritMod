...
{
	public class Star6 : ModProjectile
	{
		...
		public override bool PreAI()
		{
			...
			int dust = Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 133, 0f, 0f);
			int dust1 = Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 133, 0f, 0f);
		...
		public override void AI()
		{
			...
			projectile.Center = new Vector2(player.Center.X + (player.direction > 0 ? 40 : -40), player.position.Y + 30);   // I dont know why I had to set it to -60 so that it would look right   (change to -40 to 40 so that it's on the floor)
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("CosmicBolt"), 80, projectile.knockBack, projectile.owner, 0f, 0f);
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("CosmicBolt"), 80, projectile.knockBack, projectile.owner, 0f, 0f);

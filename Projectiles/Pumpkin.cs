	...
	public class Pumpkin : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int num623 = 0; num623 < 25; num623++) {
				int num622 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Pumpkin, 0f, 0f, 100, default(Color), 2f);
		...
		public override void AI()
		{
			...
			if (timer > 60) {
				...
				int num622 = Dust.NewDust(new Vector2(projectile.position.X - projectile.velocity.X, projectile.position.Y - projectile.velocity.Y), projectile.width, projectile.height, DustID.Pumpkin, 0f, 0f, 100, default(Color), 2f);
				Main.dust[num622].noGravity = true;

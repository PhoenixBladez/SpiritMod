...
namespace SpiritMod.Projectiles.Summon.Zones
{
	class RepulsionZone : ModProjectile, IDrawAdditive
	{
		...
		public void AdditiveCall(SpriteBatch spriteBatch, Vector2 screenPos) => ZoneHelper.ZoneAdditiveDraw(spriteBatch, Projectile, new Color(97, 46, 163), "SpiritMod/Projectiles/Summon/Zones/RepulsionZone");

...
{
	public class Terror4Summon : ModProjectile
	{
			...
			if (Main.rand.Next(40) == 0)
			{
				...
				if (num2 != -1)
				{
					...
					if (flag)
					{
						...
						value *= num5;
						int p = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value.X, value.Y, mod.ProjectileType("WitherShard3"), 54, projectile.knockBack / 2f, projectile.owner, 0f, 0f);

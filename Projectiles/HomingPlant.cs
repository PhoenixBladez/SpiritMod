...
{
	public class HomingPlant : ModProjectile
	{
		int target;
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Nature's Energy");
		}
		...
		public override void SetDefaults()
		{
			...
			projectile.timeLeft = 500;   //how many time projectile projectile has before disepire // projectile light

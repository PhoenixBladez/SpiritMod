...
{
    public class Pollen : ModProjectile
    {
        int moveSpeed = 0;
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Magic Pollen");
        }
        ...
        public override void AI() {
            ...
            if(target.active && projectile.Distance(target.Center) / 16 < range && projectile.timeLeft < 955) {

...
namespace SpiritMod.Projectiles
{
	public class WitherOrb : ModProjectile
	{
		...
		public override bool PreAI()
		{
			...
			int dust1 = Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, DustID.Blood, projectile.velocity.X * 0.5f, projectile.velocity.Y * 0.5f);
		...
		public override void AI()
		{
			...
			timer--;
			if (timer == 0) {
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, ModContent.ProjectileType<WitherShot>(), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
				timer = 120;
			}

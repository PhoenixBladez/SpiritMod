...
namespace SpiritMod.Items.Sets.TideDrops.Whirltide
{
	public class Whirltide_Bullet_Spawner_Medium : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.position.X, Projectile.position.Y - 8, 0f, -3f, ModContent.ProjectileType<Whirltide_Water_Explosion>(), 14, 9f, 0);

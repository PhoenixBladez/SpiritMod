...
namespace SpiritMod.Items.Sets.AlphaBladeTree
{
	public class SpiritStar : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			SpiritGlowmask.AddGlowMask(item.type, "SpiritMod/Items/Sets/AlphaBladeTree/SpiritStar_Glow");
		}
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("SpiritMod/Items/Sets/AlphaBladeTree/SpiritStar_Glow"),
				new Vector2
				(

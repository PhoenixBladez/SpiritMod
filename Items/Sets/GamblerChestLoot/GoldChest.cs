...
namespace SpiritMod.Items.Sets.GamblerChestLoot
{
	public class GoldChest : ModItem
	{
		...
		{
			Main.npc[NPC.NewNPC(player.GetSource_OpenItem("RightClick"), (int)player.Center.X + player.direction * 30, (int)player.Center.Y, ModContent.NPCType<GoldChestBottom>(), 0)].netUpdate = true;
		}
	}
}

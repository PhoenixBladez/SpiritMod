...
namespace SpiritMod.Items.Placeable.Furniture
{
    public class CreationAltar : ModItem
    {
        ...
        /*public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<PrimordialMagic>(), 5);
            ...
            recipe1.AddIngredient(ModContent.ItemType<OldLeather>(), 3);
            recipe1.AddIngredient(ModContent.ItemType<PrimordialMagic>(), 5);

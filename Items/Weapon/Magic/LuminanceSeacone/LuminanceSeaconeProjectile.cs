	...
	public class LuminanceSeaconeProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!hasGottenColor)
			{
				...
				{
					Dust dust = Main.dust[Dust.NewDust(projectile.Center, 0, 0, 267, 0.0f, 0.0f, 0, new Color(r,g,b), .6f)];
		...
		public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection) {Player player = Main.player[projectile.owner]; 

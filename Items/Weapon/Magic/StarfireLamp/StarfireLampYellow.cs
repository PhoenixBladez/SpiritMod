...
{
    public class StarfireLampYellow : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!primsCreated)
            {
                ...
                primsCreated = true;
                SpiritMod.primitives.CreateTrail(new StarfirePrimTrail(projectile, Microsoft.Xna.Framework.Color.OrangeRed));
            }
            ...
            {
                projectile.tileCollide = true;
                projectile.velocity = Vector2.Lerp(projectile.velocity, Vector2.Normalize(move) * 12, 0.015f);
            }
            ...
            Lighting.AddLight(player.position, 0.5f, 0.25f, 0f);

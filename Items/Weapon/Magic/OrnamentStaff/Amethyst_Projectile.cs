...
{
	public class Amethyst_Projectile : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
			  int dustIndex = Dust.NewDust(projectile.Center, 0, 0, 86, 0.0f, 0.0f, 0, new Color(), 1f);
			  ...
			  dust.scale /= 2f;
			  dust.fadeIn /= 2f;		  
			}Main.PlaySound(42, (int)projectile.position.X, (int)projectile.position.Y, 165, 1f, 0.0f);
		}
	}
}

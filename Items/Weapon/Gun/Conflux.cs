...
namespace SpiritMod.Items.Weapon.Gun
{
	public class Conflux : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			SpiritGlowmask.AddGlowMask(item.type, "SpiritMod/Items/Weapon/Gun/Conflux_Glow");
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("SpiritMod/Items/Weapon/Gun/Conflux_Glow"),
				new Vector2
				(
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Scattergun>(), 1);

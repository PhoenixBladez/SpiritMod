...
namespace SpiritMod.Items.Weapon.Summon.Zones
{
	public class RepulsionCodex : ModItem
	{
		public override void SetStaticDefaults()
		{
            ...
            SpiritGlowmask.AddGlowMask(item.type, "SpiritMod/Items/Weapon/Summon/Zones/RepulsionCodex_Glow");
        }
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            spriteBatch.Draw
            (
                mod.GetTexture("Items/Weapon/Summon/Zones/RepulsionCodex_Glow"),
                new Vector2
                (

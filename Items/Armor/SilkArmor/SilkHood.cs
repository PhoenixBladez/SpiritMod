...
namespace SpiritMod.Items.Armor.SilkArmor
{
	...
	public class SilkHood : ModItem
	{
		...
		public override void UpdateEquip(Player player) => player.maxMinions += 1;
		public override bool IsArmorSet(Item head, Item body, Item legs) => body.type == ModContent.ItemType<SilkRobe>() && legs.type == ModContent.ItemType<SilkLegs>();

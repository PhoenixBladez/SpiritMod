...
namespace SpiritMod.Items.BossLoot.StarplateDrops
{
	public class AstralLens : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			SpiritGlowmask.AddGlowMask(Item.type, "SpiritMod/Items/BossLoot/StarplateDrops/AstralLens_Glow");
		}
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
		{
			...
			spriteBatch.Draw
			(
				ModContent.Request<Texture2D>("SpiritMod/Items/BossLoot/StarplateDrops/AstralLens_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value,
				new Vector2
				(

...
namespace SpiritMod.Items.BossLoot.MoonWizardDrops
{
	public class Moonburst : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			SpiritGlowmask.AddGlowMask(Item.type, "SpiritMod/Items/BossLoot/MoonWizardDrops/Moonburst_Glow");
		}
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
		{
			...
			spriteBatch.Draw
			(
				Mod.Assets.Request<Texture2D>("Items/BossLoot/MoonWizardDrops/Moonburst_Glow").Value,
				new Vector2
				(

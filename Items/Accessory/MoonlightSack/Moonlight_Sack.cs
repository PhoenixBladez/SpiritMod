	...
	public class Moonlight_Sack : ModItem
	{
		...
		public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI) 
		{
			...
			for (int index2 = 0; index2 < num7; ++index2)
			{
				...
				Main.spriteBatch.Draw(Mod.Assets.Request<Texture2D>("Items/Accessory/MoonlightSack/Moonlight_Sack_Glow").Value, position2, new Microsoft.Xna.Framework.Rectangle?(aga), faa, rotation, vector2_3, Item.scale, spriteEffects, 0.0f);
			}
			for (int index2 = 0; index2 < 4; ++index2)
			{
				...
				Main.spriteBatch.Draw(Mod.Assets.Request<Texture2D>("Items/Accessory/MoonlightSack/Moonlight_Sack_Glow").Value, pos2, new Microsoft.Xna.Framework.Rectangle?(aga), color2, rotation, vector2_3, Item.scale, spriteEffects, 0.0f);
			}
			Main.spriteBatch.Draw(Mod.Assets.Request<Texture2D>("Items/Accessory/MoonlightSack/Moonlight_Sack_Glow").Value, bb, new Microsoft.Xna.Framework.Rectangle?(aga), color2, rotation, vector2_3, Item.scale, spriteEffects, 0.0f);
			return false;
		}
	}
}
		...
		public override bool UseItem(Player player)
		{
			if (player.ZoneOverworldHeight || player.ZoneSkyHeight) {
				...
				if (Main.netMode == NetmodeID.SinglePlayer)
					...
					SpiritMod.WriteToPacket(SpiritMod.Instance.GetPacket(), (byte)MessageType.BossSpawnFromClient, (byte)player.whoAmI, ModContent.NPCType<AncientFlyer>(), (int)spawnPos.X, (int)spawnPos.Y).Send(-1);
				}

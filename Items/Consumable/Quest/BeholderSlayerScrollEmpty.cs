...
{
	public class BeholderSlayerScrollEmpty : ModItem
	{
		...
		{
			player.GetSpiritPlayer().emptyBeholderScroll = true;
		}
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			tooltips.Add(line1);
			TooltipLine line2 = new TooltipLine(mod, "SocialDesc", "Beholder");
			line2.overrideColor = new Color(255, 207, 51);
			tooltips.Add(line2);
		}
	}
}

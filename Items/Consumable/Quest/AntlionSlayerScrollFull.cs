...
{
    public class AntlionSlayerScrollFull : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(line);
            TooltipLine line1 = new TooltipLine(mod, "FavoriteDesc", "The Antlion Assassin Slayer Contract has been completed!");

...
{
    public class ExplorerScrollGraniteEmpty : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(line1);
            TooltipLine line2 = new TooltipLine(mod, "SocialDesc", "Granite Caverns");
            line2.overrideColor = new Color(112, 111, 163);
            tooltips.Add(line2);
        }
    }
}

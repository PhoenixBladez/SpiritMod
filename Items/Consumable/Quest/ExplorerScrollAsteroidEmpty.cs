...
{
    public class ExplorerScrollAsteroidEmpty : ModItem
    {
        ...
        {
            if (player.GetSpiritPlayer().explorerTimer > 0 && player.GetSpiritPlayer().ZoneAsteroid)
            {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(line1);
            TooltipLine line2 = new TooltipLine(mod, "SocialDesc", "Asteroid Fields");
            line2.overrideColor = new Color(176, 144, 128);
            tooltips.Add(line2);
        }
    }
}

...
{
	public class ExplorerScrollHiveEmpty : ModItem
	{
		...
		{
			if(player.GetSpiritPlayer().explorerTimer > 0 && player.GetSpiritPlayer().ZoneHive) {
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			tooltips.Add(line1);
			TooltipLine line2 = new TooltipLine(mod, "SocialDesc", "Giant Beehive");
			line2.overrideColor = new Color(255, 187, 105);
			tooltips.Add(line2);
		}
	}
}

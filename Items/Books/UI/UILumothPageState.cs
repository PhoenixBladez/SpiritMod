...
{
	class UILumothPageState : UIState
	{
		...
		public override void OnInitialize() {
			...
			var panelBackground = new UIImage(ModContent.Request<Texture2D>("SpiritMod/Items/Books/UI/LumothPage"));

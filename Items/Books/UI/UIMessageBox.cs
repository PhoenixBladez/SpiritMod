...
namespace SpiritMod.Items.Books.UI
{
	...
	internal class UIMessageBox : UIElement // Swap to inheriting from UIElement if you don't want the Panel behind.
	{
		private string text;
...
//namespace SpiritMod.Items.Books.UI
//{
//	// Copied from Terraria since the class is internal
//	internal class UIMessageBox : UIPanel
//	{

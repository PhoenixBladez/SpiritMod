...
namespace SpiritMod.Items.Books
{
    class Book_Briar : Book
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("by Field Researcher Nisha");
        }
    }
}
...
namespace SpiritMod.Items.Books
{
    class Book_ArmorGuide : Book
    {
        public override string BookText => "[c/95a3ab:The following is a transcript of an informational speech made by renowned adventurer Aurelius Finch, Knight-Crusader.]\n\n---\n\n" +
            ...
            "[i:" + SpiritMod.Instance.ItemType("DaybloomHead") + "] [i:" + SpiritMod.Instance.ItemType("DaybloomBody") + "] [i:" + SpiritMod.Instance.ItemType("DaybloomLegs") + "][c/80deed: Daybloom Armor:] Are you an aspiring mage? Well, I'm not- haven't got a magical bone in my body! But this thin and comfortable set of armor, made from [c/72a4c2:Daybloom] and [c/72a4c2:Fallen Stars], can give a boost to your magic power.\n\n" +

            ...
            if (bossChecklist != null)
            {
                ...
                bossChecklist.Call(
                    ...
                    new List<int> { ModContent.ItemType<NautilusClub>(), ModContent.ItemType<ElectricGun>(), ModContent.ItemType<DreamlightJellyItem>(), ModContent.ItemType<TinyLunazoaItem>() },
                     "Naturally occurs in space after any boss has been defeated. Can also be summoned by using a Distress Jelly, found in Asteroid Biomes. Occurs less frequently after the Moon Jelly Wizard has been defeated.",
                    null,

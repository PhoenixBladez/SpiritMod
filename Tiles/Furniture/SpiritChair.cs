...
namespace SpiritMod.Tiles.Furniture
{
	public class SpiritChair : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<SpiritChairItem>());
		...
		public override void MouseOver(int i, int j) => FurnitureHelper.MouseOver(i, j, ModContent.ItemType<SpiritChairItem>());
	}
}
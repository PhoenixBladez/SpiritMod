...
namespace SpiritMod.Tiles.Furniture.NeonLights
{
	public class RedLightsSmall : ModTile
	{
		...
		{
			Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 48, ModContent.ItemType<Items.Placeable.Furniture.Neon.RedFairyLights>());
		}
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            Tile tile = Framing.GetTileSafely(i, j);
            {
                ...
                Texture2D glow = ModContent.Request<Texture2D>("SpiritMod/Tiles/Furniture/NeonLights/RedLightsSmall_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;

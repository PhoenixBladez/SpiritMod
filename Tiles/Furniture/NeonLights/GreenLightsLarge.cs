...
namespace SpiritMod.Tiles.Furniture.NeonLights
{
	public class GreenLightsLarge : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 48, ModContent.ItemType<Items.Placeable.Furniture.Neon.GreenNeonLamp>());
		}
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            Tile tile = Framing.GetTileSafely(i, j);
            {
                ...
                Texture2D glow = ModContent.GetTexture("SpiritMod/Tiles/Furniture/NeonLights/GreenLightsLarge_Glow");

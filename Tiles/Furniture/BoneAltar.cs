...
namespace SpiritMod.Tiles.Furniture
{
	public class BoneAltar : ModTile
	{
		...
		{
			for (int a = 0; a < 30; a++) {
				Vector2 vector23 = Vector2.UnitY.RotatedByRandom(MathHelper.TwoPi) * new Vector2(40f, 40f);
				int index1 = Dust.NewDust(new Vector2(i * 16, j * 16 - 30) + vector23, 0, 0, DustID.Fire, 0.0f, 0.0f, 0, new Color(), 1f);

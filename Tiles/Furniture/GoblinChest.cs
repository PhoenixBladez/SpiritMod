...
{
	public class GoblinChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			if (chest < 0) {
				...
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Dynasty Chest";
				if (player.cursorItemIconText == "Dynasty Chest") {
					player.cursorItemIconID = ItemID.DynastyChest;

	...
	public class ReachChest : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			if (chest < 0) {
				...
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Briar Chest";
				if (player.cursorItemIconText == "Briar Chest") {
					player.cursorItemIconID = ModContent.ItemType<ReachChestTile>();

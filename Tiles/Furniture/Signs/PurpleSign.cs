...
namespace SpiritMod.Tiles.Furniture.Signs
{
	public class PurpleSign : ModTile
	{
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ItemType<PurpleNeonSign>());

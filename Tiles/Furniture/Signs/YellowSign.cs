...
namespace SpiritMod.Tiles.Furniture.Signs
{
	public class YellowSign : ModTile
	{
	   ...
	   public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placeable.Furniture.Neon.YellowNeonSign>());
        }
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(GetTexture("SpiritMod/Tiles/Furniture/Signs/YellowSign_Glow"), new Vector2(i, j) * 16 - Main.screenPosition + zero, new Rectangle(tile.frameX, tile.frameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
    }
}

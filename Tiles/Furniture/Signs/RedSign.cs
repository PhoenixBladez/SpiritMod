...
namespace SpiritMod.Tiles.Furniture.Signs
{
	public class RedSign : ModTile
	{
	   ...
	   public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        ...
        {
            Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placeable.Furniture.Neon.RedNeonSign>());
        }
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(ModContent.Request<Texture2D>("SpiritMod/Tiles/Furniture/Signs/RedSign_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value, new Vector2(i, j) * 16 - Main.screenPosition + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
    }
}

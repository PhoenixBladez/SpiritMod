	...
	public class RedSign : ModTile
	{
	   ...
	   public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(GetTexture("SpiritMod/Tiles/Furniture/Signs/RedSign_Glow"), new Vector2(i, j) * 16 - Main.screenPosition + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
    }
}

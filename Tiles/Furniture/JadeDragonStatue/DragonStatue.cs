...
namespace SpiritMod.Tiles.Furniture.JadeDragonStatue
{
	public class DragonStatue : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<DragonStatueItem>());
	}
}

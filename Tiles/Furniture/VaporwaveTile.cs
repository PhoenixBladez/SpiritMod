	...
	public class VaporwaveTile : ModTile
	{
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (tile.TileFrameY == 0 || tile.TileFrameY == 18 || tile.TileFrameY == 36 || tile.TileFrameY == 54 || tile.TileFrameY == 72 )
            {
                ...
                Texture2D glow = ModContent.Request<Texture2D>("SpiritMod/Tiles/Furniture/VaporwaveTile_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placeable.Furniture.Neon.VaporwaveItem>());
		}
	}
}
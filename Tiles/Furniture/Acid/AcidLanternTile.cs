...
namespace SpiritMod.Tiles.Furniture.Acid
{
	public class AcidLanternTile : ModTile
	{
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(Mod.GetTexture("Tiles/Furniture/Acid/AcidLanternTile_Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);

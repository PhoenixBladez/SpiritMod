	...
	public class ShadowflameStone : ModTile
	{
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			if (t.TileFrameX % 54 == 0 && t.TileFrameY == 0) {
				Main.spriteBatch.Draw(TextureAssets.Extra[49][60], new Vector2(i * 16 - (int)Main.screenPosition.X - 44, j * 16 - (int)Main.screenPosition.Y - 32) + zero, null, new Color(169, 3, 252, 0), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			}
		}
	}
}

...
namespace SpiritMod.Tiles.Ambient.Corals
{
	public class Coral1x2 : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ItemID.Coral, Main.rand.Next(1, 3));

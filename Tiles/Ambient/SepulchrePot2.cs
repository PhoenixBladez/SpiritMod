	...
	public class SepulchrePot2 : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			for (int k = 0; k < 8; k++) {
				...
				Gore.NewGore(new Terraria.DataStructures.EntitySource_TileBreak(i, j), new Vector2((int)i * 16 + Main.rand.Next(-10, 10), (int)j * 16 + Main.rand.Next(-10, 10)), new Vector2(-1, 1), Mod.Find<ModGore>("SpiritMod/Gores/Pot1").Type, 1f);
			}

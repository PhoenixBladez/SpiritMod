...
namespace SpiritMod.Tiles.Ambient.SpaceCrystals
{
    public class GlowShard2 : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch) {
            ...
            Main.spriteBatch.Draw(mod.GetTexture("Tiles/Ambient/SpaceCrystals/GlowShard2_Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y + 2) + zero, new Rectangle(tile.frameX, tile.frameY, 16, height), new Color(100, 100, 100), 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }

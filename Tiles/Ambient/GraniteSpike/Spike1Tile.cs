...
namespace SpiritMod.Tiles.Ambient.GraniteSpike
{
	public class Spike1Tile : ModTile
	{
		...
		{
			Terraria.Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeable.Furniture.GraniteSpikes.GraniteSpike1>());
		}
	}
}
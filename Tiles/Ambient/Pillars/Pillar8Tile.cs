...
namespace SpiritMod.Tiles.Ambient.Pillars
{
	public class Pillar8Tile : ModTile
	{
		...
		{
			Terraria.Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeable.Furniture.MarblePillars.Pillar8>());
		}
	}
}
...
{
	public class NeonBlockYellow : ModTile
	{
		public override void SetStaticDefaults()
		{
            ...
            ItemDrop = ModContent.ItemType<NeonBlockYellowItem>();
		}
		...
		{
			Texture2D glow = ModContent.Request<Texture2D>("SpiritMod/Tiles/Block/NeonBlockYellow_Glow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;

...
{
	public class PurpleAlgaeSky : CustomSky
	{
		...
		{
			this._bgTexture = ModContent.Request<Texture2D>("Terraria/Images/Misc/NebulaSky/Background", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
		}

		...
		public override void Update(NPC npc, ref int buffIndex)
		{
            ...
            if (info.angelLightStacks == 2)
            {
                ...
                for (int k = 0; k < Main.rand.Next(1, 3); k++)
                {
                    ...
                    int proj = Projectile.NewProjectile(npc.position.X, npc.position.Y + Main.rand.Next(-400, -380), SpeedX, SpeedY, mod.ProjectileType("AngelLightStar"), 50, 0, Main.myPlayer, 0.0f, 1);
